        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerFeedbackId = table.Column<int>(nullable: true),
                    OperatedBy = table.Column<string>(nullable: true),
                    OperationistFeedbackId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserHistory", x => x.HistoryId);
                    table.ForeignKey(
                        name: "FK_UserHistory_FeedBack_CustomerFeedbackId",
                        column: x => x.CustomerFeedbackId,
                        principalTable: "FeedBack",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserHistory_FeedBack_OperationistFeedbackId",
                        column: x => x.OperationistFeedbackId,
                        principalTable: "FeedBack",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHistory_CustomerFeedbackId",
                table: "UserHistory",
                column: "CustomerFeedbackId");

            migrationBuilder.CreateIndex(
                name: "IX_UserHistory_OperationistFeedbackId",
                table: "UserHistory",
                column: "OperationistFeedbackId");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNotificationsAllowed = table.Column<bool>(nullable: false),
